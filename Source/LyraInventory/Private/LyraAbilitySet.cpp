...
void FLyraAbilitySet_GrantedHandles::TakeFromAbilitySystem(UAbilitySystemComponent* LyraASC)
{
	check(LyraASC);
...
void ULyraAbilitySet::GiveToAbilitySystem(UAbilitySystemComponent* LyraASC, FLyraAbilitySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject) const
{
	check(LyraASC);
