...
class LYRAINVENTORY_API ULyraInventoryItemInstance : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName="GetItemDef"))
	TSubclassOf<ULyraInventoryItemDefinition> GetItemDef_BP()
	{
		return ItemDef;
	}
	...
	TSubclassOf<ULyraEquipmentDefinition> GetEquipmentDefinition() const;
