#include "DAOTargetingSelectionTask_Trace.h"
...
UDAOTargetingSelectionTask_Trace::UDAOTargetingSelectionTask_Trace(const FObjectInitializer& ObjectInitializer)
...
void UDAOTargetingSelectionTask_Trace::Execute(const FTargetingRequestHandle& TargetingHandle) const
{
...
FVector UDAOTargetingSelectionTask_Trace::GetSourceLocation_Implementation(const FTargetingRequestHandle& TargetingHandle) const
{
...
FVector UDAOTargetingSelectionTask_Trace::GetSourceOffset_Implementation(const FTargetingRequestHandle& TargetingHandle) const
{
	return DefaultSourceOffset;
}

FVector UDAOTargetingSelectionTask_Trace::GetTraceDirection_Implementation(const FTargetingRequestHandle& TargetingHandle) const
{
...
float UDAOTargetingSelectionTask_Trace::GetTraceLength_Implementation(const FTargetingRequestHandle& TargetingHandle) const
{
	return DefaultTraceLength.GetValue();
}

float UDAOTargetingSelectionTask_Trace::GetSweptTraceRadius_Implementation(const FTargetingRequestHandle& TargetingHandle) const
{
	return DefaultSweptTraceRadius.GetValue();
}

float UDAOTargetingSelectionTask_Trace::GetSweptTraceCapsuleHalfHeight_Implementation(const FTargetingRequestHandle& TargetingHandle) const
{
	return DefaultSweptTraceCapsuleHalfHeight.GetValue();
}

FVector UDAOTargetingSelectionTask_Trace::GetSweptTraceBoxHalfExtents_Implementation(const FTargetingRequestHandle& TargetingHandle) const
{
...
FRotator UDAOTargetingSelectionTask_Trace::GetSweptTraceRotation_Implementation(const FTargetingRequestHandle& TargetingHandle) const
{
	return DefaultSweptTraceRotation;
}

void UDAOTargetingSelectionTask_Trace::GetAdditionalActorsToIgnore_Implementation(const FTargetingRequestHandle& TargetingHandle, TArray<AActor*>& OutAdditionalActorsToIgnore) const
{
}

FQuat UDAOTargetingSelectionTask_Trace::GetSweptTraceQuat(const FVector& TraceDirection, const FTargetingRequestHandle& TargetingHandle) const
{
...
void UDAOTargetingSelectionTask_Trace::ExecuteImmediateTrace(const FTargetingRequestHandle& TargetingHandle) const
{
	if (UWorld* World = GetSourceContextWorld(TargetingHandle))
	{
		...
		// End should be the mouse location click
...
void UDAOTargetingSelectionTask_Trace::ExecuteAsyncTrace(const FTargetingRequestHandle& TargetingHandle) const
{
	if (UWorld* World = GetSourceContextWorld(TargetingHandle))
	{
		...
		FTraceDelegate Delegate = FTraceDelegate::CreateUObject(this, &UDAOTargetingSelectionTask_Trace::HandleAsyncTraceComplete, TargetingHandle);
		if (CollisionProfileName.Name != TEXT("NoCollision"))
		{
			switch (TraceType)
			{
...
void UDAOTargetingSelectionTask_Trace::HandleAsyncTraceComplete(const FTraceHandle& InTraceHandle, FTraceDatum& InTraceDatum, FTargetingRequestHandle TargetingHandle) const
{
...
void UDAOTargetingSelectionTask_Trace::ProcessHitResults(const FTargetingRequestHandle& TargetingHandle, const TArray<FHitResult>& Hits) const
{
...
void UDAOTargetingSelectionTask_Trace::InitCollisionParams(const FTargetingRequestHandle& TargetingHandle, FCollisionQueryParams& OutParams) const
{
	if (const FTargetingSourceContext* SourceContext = FTargetingSourceContext::Find(TargetingHandle))
	{
...
#if WITH_EDITOR
bool UDAOTargetingSelectionTask_Trace::CanEditChange(const FProperty* InProperty) const
{
	...
	if (bCanEdit && InProperty)
	{
		...
		if (PropertyName == GET_MEMBER_NAME_CHECKED(UDAOTargetingSelectionTask_Trace, DefaultSweptTraceRadius))
		{
			return (TraceType == ETargetingTraceType::Sphere || TraceType == ETargetingTraceType::Capsule);
		}

		if (PropertyName == GET_MEMBER_NAME_CHECKED(UDAOTargetingSelectionTask_Trace, DefaultSweptTraceCapsuleHalfHeight))
		{
			return (TraceType == ETargetingTraceType::Capsule);
		}

		if (PropertyName == GET_MEMBER_NAME_CHECKED(UDAOTargetingSelectionTask_Trace, DefaultSweptTraceBoxHalfExtentX)
			|| PropertyName == GET_MEMBER_NAME_CHECKED(UDAOTargetingSelectionTask_Trace, DefaultSweptTraceBoxHalfExtentY)
			|| PropertyName == GET_MEMBER_NAME_CHECKED(UDAOTargetingSelectionTask_Trace, DefaultSweptTraceBoxHalfExtentZ))
		{
			return (TraceType == ETargetingTraceType::Box);
		}

		if (PropertyName == GET_MEMBER_NAME_CHECKED(UDAOTargetingSelectionTask_Trace, DefaultSweptTraceRotation))
		{
			return (TraceType == ETargetingTraceType::Capsule || TraceType == ETargetingTraceType::Box);
		}

		if (PropertyName == GET_MEMBER_NAME_CHECKED(UDAOTargetingSelectionTask_Trace, TraceChannel))
		{
...
#if ENABLE_DRAW_DEBUG
void UDAOTargetingSelectionTask_Trace::DrawDebug(UTargetingSubsystem* TargetingSubsystem, FTargetingDebugInfo& Info, const FTargetingRequestHandle& TargetingHandle, float XOffset, float YOffset, int32 MinTextRowsToAdvance) const
{
...
void UDAOTargetingSelectionTask_Trace::DrawDebugTrace(const FTargetingRequestHandle TargetingHandle, const FVector& StartLocation, const FVector& EndLocation, const FQuat& OrientationQuat, const bool bHit, const TArray<FHitResult>& Hits) const
{
	if (UTargetingSubsystem::IsTargetingDebugEnabled())
	{
		if (UWorld* World = GetSourceContextWorld(TargetingHandle))
...
void UDAOTargetingSelectionTask_Trace::BuildTraceResultsDebugString(const FTargetingRequestHandle& TargetingHandle, const TArray<FTargetingDefaultResultData>& TargetResults) const
{
#if WITH_EDITORONLY_DATA
	if (UTargetingSubsystem::IsTargetingDebugEnabled())
	{
...
void UDAOTargetingSelectionTask_Trace::ResetTraceResultsDebugString(const FTargetingRequestHandle& TargetingHandle) const
{
#if WITH_EDITORONLY_DATA
	FTargetingDebugData& DebugData = FTargetingDebugData::FindOrAdd(TargetingHandle);
	FString& ScratchPadString = DebugData.DebugScratchPadStrings.FindOrAdd(GetNameSafe(this));
