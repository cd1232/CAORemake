...
#include "DAOTargetingSelectionTask_AOE.generated.h"
...
/**
*	@class UDAOTargetingSelectionTask_AOE
*
...
class DAO_API UDAOTargetingSelectionTask_AOE : public UTargetingTask
{
	GENERATED_BODY()

public:
	UDAOTargetingSelectionTask_AOE(const FObjectInitializer& ObjectInitializer);
