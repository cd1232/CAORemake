...
#include "DAOTargetingSelectionTask_Trace.generated.h"
...
/**
*	@class UDAOTargetingSelectionTask_Trace
*
...
class DAO_API UDAOTargetingSelectionTask_Trace : public UTargetingTask
{
	GENERATED_BODY()

public:
	UDAOTargetingSelectionTask_Trace(const FObjectInitializer& ObjectInitializer);
