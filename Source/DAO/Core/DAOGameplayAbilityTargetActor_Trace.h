...
#include "DAOGameplayAbilityTargetActor_Trace.generated.h"
...
class DAO_API ADAOGameplayAbilityTargetActor_Trace : public AGameplayAbilityTargetActor
{
...
public:
	...
	void AimWithMouse(const AActor* InSourceActor, FCollisionQueryParams Params, FVector& OutTraceStart, FVector& OutTraceEnd) const;
...
protected:
	...
	TWeakObjectPtr<AActor> ValidActor;
};
