	...
	this->GetOrAddSlot( ENodeZone::Center )
		...
		[
			...
			[
				...
				[
					...
					[
						...
						[
							...
							.BorderBackgroundColor(this, &SGraphNode_QuestTree::GetBackgroundColor)
							.HAlign(HAlign_Fill)
							.VAlign(VAlign_Center)
				...
				[
					SNew(STextBlock)
					.Text(this, &SGraphNode_QuestTree::GetNodeID)
				]
...
FSlateColor SGraphNode_QuestTree::GetBorderBackgroundColor() const
{
	const bool bIsConnectedTreeRoot = QuestNode && QuestNode->IsA<UQuestTreeGraphNode_Start>()
	&& QuestNode->Pins.IsValidIndex(0) && QuestNode->Pins[0]->LinkedTo.Num() > 0;

	// TODO Debugging

	return bIsConnectedTreeRoot ? QuestTreeColors::NodeBorder::Root : QuestTreeColors::NodeBorder::Inactive;
}

FSlateColor SGraphNode_QuestTree::GetBackgroundColor() const
{
	return QuestTreeColors::NodeBody::Default;
}

FText SGraphNode_QuestTree::GetNodeID() const
{
	return FText::AsNumber(QuestNode->GetNodeID());
}
...
{
	return FSlateColor(IsHovered() ? QuestTreeColors::Pin::Hover : QuestTreeColors::Pin::Default);
}
